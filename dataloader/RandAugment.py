...
def _posterize_increasing_level_to_arg(level, hparams):
    ...
    return 4 - _posterize_level_to_arg(level, hparams)
...
def _solarize_increasing_level_to_arg(level, _hparams):
    # range [0, 256]
    # intensity/severity of augmentation increases with level
    return 256 - _solarize_level_to_arg(level, _hparams)
...
class AugmentOp:
    ...
    def __call__(self, img):
        ...
        # Ensure level_args is iterable
        if not hasattr(level_args, '__iter__'):
